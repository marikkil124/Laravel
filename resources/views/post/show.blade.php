    ...
    <main class="blog-post">
        <div class="container">
            ...
            <p class="edica-blog-post-meta" data-aos="fade-up" data-aos-delay="200">Written by Richard Searls•
                {{ $date->translatedFormat("M,d,Y")}} • {{$date->format('H:m')}} • {{$post->comments->count()}}
                Комментариев</p>
                ...
                <div class="col-lg-9 mx-auto">
                        ...
                        <div class="row">
                            @foreach($relatedposts as $relPost)
                                <div class="col-md-4" data-aos="fade-right" data-aos-delay="100">
                                    ...
                                    <a href="{{route('post.show',$relPost->id)}}"><h5
                                            class="post-title">  {{$relPost->title}}</h5></a>
                                </div>
                            @endforeach
                        </div>
                    </section>
                  ...
                  @auth()
                    <section class="comment-section">
                        <h2 class="section-title mb-5" data-aos="fade-up">Отправить комменатарий</h2>
